...
abstract class RPCFillOrKillParam {
...
class RPCFillOrKillX128Price extends RPCFillOrKillParam {
  final String minPriceX128;
  const RPCFillOrKillX128Price(
...
class RuntimeApiResponse {
  ...
  factory RuntimeApiResponse.fromJson(List<dynamic> json) {
    return RuntimeApiResponse(hexString: json[0], version: json[1]);
  }
...
class TRPCOpenDepositChannelResponse {
  ...
  const TRPCOpenDepositChannelResponse(
      {required this.id,
      required this.depositAddress,
